...
public class DetailDakwahHarianIndo3 extends Activity{
	...
	public void onCreate(Bundle bundle){
		...
		webview = (WebView) findViewById(R.id.webView1);
		 ...
		 String content = ambilResource(getResources(),R.raw.orang_yang_paling_dekat_dengan_nabi_saw_di_hari_kiamat);
